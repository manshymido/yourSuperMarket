...
let PaymentsService = PaymentsService_1 = class PaymentsService {
    ...
    async createPayment(orderId, method) {
        ...
        throw new common_1.BadRequestException(error_messages_1.ERROR_MESSAGES.INVALID_PAYMENT_METHOD);
    }
    ...
    async handlePaymobCallback(data) {
        ...
        if (!payment) {
            throw new common_1.NotFoundException(error_messages_1.ERROR_MESSAGES.PAYMENT_NOT_FOUND);
        }
