...
export declare class DeliveryController {
    ...
    acceptDelivery(user: CurrentUserPayload, deliveryId: string): Promise<{
        order: {
            user: {
                email: string | null;
                phone: string | null;
    ...
    updateStatus(deliveryId: string, body: {
    ...
    getDriverDeliveries(user: CurrentUserPayload): Promise<({
        order: {
            user: {
                cart: {
                    id: string;
