...
let AuthService = AuthService_1 = class AuthService {
    ...
    async register(registerDto) {
        ...
        if (phone) {
            ...
            if (existingUser) {
                throw new common_1.ConflictException(error_messages_1.ERROR_MESSAGES.PHONE_ALREADY_EXISTS);
            }
        }
    ...
    async login(loginDto) {
        ...
        if (!user.isActive) {
            throw new common_1.UnauthorizedException(error_messages_1.ERROR_MESSAGES.ACCOUNT_INACTIVE);
        }
    ...
    async resetPassword(resetPasswordDto) {
        ...
        if (!resetToken) {
            throw new common_1.BadRequestException(error_messages_1.ERROR_MESSAGES.INVALID_OR_EXPIRED_RESET_TOKEN);
        }
        if (resetToken.used) {
            throw new common_1.BadRequestException(error_messages_1.ERROR_MESSAGES.RESET_TOKEN_ALREADY_USED);
        }
        if (resetToken.expiresAt < new Date()) {
            ...
            throw new common_1.BadRequestException(error_messages_1.ERROR_MESSAGES.RESET_TOKEN_EXPIRED);
        }
    ...
    validateEmailOrPhone(email, phone) {
        if (!email && !phone) {
            throw new common_1.BadRequestException(error_messages_1.ERROR_MESSAGES.EMAIL_OR_PHONE_REQUIRED);
        }
    }
