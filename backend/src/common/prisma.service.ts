  ...
  implements OnModuleInit, OnModuleDestroy
{
  ...
  constructor() {
    ...
    // Get log levels before calling super (cannot use 'this' before super)
    const logLevels = PrismaService.getLogLevels(logLevel);
  ...
  private static getLogLevels(level: string): Array<'query' | 'info' | 'warn' | 'error'> {
